//! Live EuRoC stereo egomotion via an INHIBITION-DOMINATED spike-coding network
//! on the IQIF chip, with real-time minifb visualization + faded GT overlay.
//!
...
fn main() {
    ...
    let mut window = Window::new(
        "iqif-vio - EuRoC inhibition-dominated SCN egomotion (live, on IQIF)",
        win_w,
        win_h,
        WindowOptions {
            resize: false,
